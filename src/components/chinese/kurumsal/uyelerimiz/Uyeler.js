import "./Uyeler.css";
import u3 from "../../../turkish/kurumsal/uyelerimiz/uyeler/u3.jpg";
import u4 from "../../../turkish/kurumsal/uyelerimiz/uyeler/u4.jpg";
import u5 from "../../../turkish/kurumsal/uyelerimiz/uyeler/u5.jpg";
import u6 from "../../../turkish/kurumsal/uyelerimiz/uyeler/u6.jpg";
import u8 from "../../../turkish/kurumsal/uyelerimiz/uyeler/u8.jpg";
import u9 from "../../../turkish/kurumsal/uyelerimiz/uyeler/u9.jpg";
import u10 from "../../../turkish/kurumsal/uyelerimiz/uyeler/u10.jpg";
               ...
               <div className="col-lg-4 col-md-6 col-sm-6 col-12 uye_temp">
                   <div className="uye_cerceve">
                       ...
                       <div className="uye_bilgi">
                               ...
                               <p className="uye_gorev">董事会成员</p>
                               <p className="uye_meslek">律师</p>
                       </div>
                   </div>
               </div>
               <div className="col-lg-4 col-md-6 col-sm-6 col-12 uye_temp">
               ...
               <div className="col-lg-4 col-md-6 col-sm-6 col-12 uye_temp">
                   <div className="uye_cerceve">
                       ...
                       <div className="uye_bilgi">
                               ...
                               <p className="uye_gorev">总裁秘书</p>
                               <p className="uye_meslek">秘书</p>
                       </div>
                   </div>
               </div>
               <div className="col-lg-4 col-md-6 col-sm-6 col-12 uye_temp">
                   <div className="uye_cerceve">
                       ...
                       <div className="uye_bilgi">
                               ...
                               <p className="uye_gorev">财务顾问</p>
                               <p className="uye_meslek">财务顾问</p>
                       </div>
                   </div>
               </div>
               <div className="col-lg-4 col-md-6 col-sm-6 col-12 uye_temp">
